...
public class ScrollRectSnap : MonoBehaviour
{
    ...
    public float[] distReposition; // take the parent position of the buttons 
    private bool dragging = false;  // will be true, while we drag the panel
    private int bttnDistance;  // will hold distance betwen buttons
    private int minButtonNum; // will compare distances which is the smalest to center
    ...
    void Update()
    {
        ...
        float minDistance = Mathf.Min(distance); // getting the min distance
